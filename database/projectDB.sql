...
create table persons(
    ...
    person_password char(64) not null,
    person_id_number char(64) not null,
    person_birth_date Date not null,
    person_email char(64) not null,
...
create table vacancy_category(
    ...
    vacancy_name char(100) not null,
...
create table skill_level(
    ...
    skill_level_name char(64) not null,
...
create table university(
    ...
    university_name char (64) not null,
...
create table company_info(
    ...
    company_email char(64) not null,
    company_info TEXT,
...
create table working_experience(
    ...
    constraint working_experience_fk2 foreign key(company_id) references company_info(company_id)

);
create table offer(
	offer_id int not null auto_increment,
    offer_info text,
    offer_name char(100) not null,
...
create table documents(
    ...
    document_name char(64) not null,
